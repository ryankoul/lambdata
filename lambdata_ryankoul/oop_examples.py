...
class Complex:
    ...
    # Lets you define how Python will represent your object
    # By default, it prints the object's memory address, not its values
    # So we'll return a string of the complex number's components
    def __repr__(self):
